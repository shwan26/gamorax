...
import { ArrowLeft, Mail, Info, GraduationCap } from "lucide-react";

export default function LecturerForgotPasswordPage() {
            ...
            >
              ...
              <div className="relative flex items-center gap-3">
                <div className="rounded-2xl border border-slate-200/80 bg-white/90 p-3 shadow-sm dark:border-slate-700/80 dark:bg-slate-950/70">
                  <Mail className="h-6 w-6 text-[#020024] dark:text-[#00D4FF]" />
                </div>
              ...
              <div className="relative mt-6 space-y-4">
                {!sent ? (
                  <>
                    ...
                    <div
                      className="
                        flex items-start gap-2 rounded-2xl border border-slate-200/70 bg-white/60 p-3
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="mt-1">
                          This app uses localStorage auth right now, so email reset isn’t connected yet.
                  ...
                  <div
                    className="
                      rounded-2xl border border-slate-200/70 bg-white/60 p-4 text-sm text-slate-700 backdrop-blur
                  ...
                  >
                    ...
                    <div className="mt-4 flex gap-3">
                      <Link
                        href="/login"
                        className="
                          rounded-xl border border-slate-200/80 bg-white/80 px-3 py-2 text-sm text-slate-700 shadow-sm
