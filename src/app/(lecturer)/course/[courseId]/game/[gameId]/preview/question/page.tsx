// src/app/(lecturer)/course/[courseId]/game/[gameId]/preview/question/page.tsx
"use client";
...
export default function Page() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const ok = await requireLecturerOrRedirect(
        `/course/${courseId}/game/${gameId}/preview/question`
      );
      if (!ok) return;
  ...
  return (
    <div className="min-h-screen app-surface app-bg">
      ...
      {loading ? (
        <div className="p-10 text-sm text-slate-600">Loading preview…</div>
      ) : !courseId || !gameId ? (
